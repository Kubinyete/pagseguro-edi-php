...
class FinantialMovement extends Model
{
    ...
    public function getIdentificadorRevenda(): ?string
    {
        return $this->get('identificador_revenda');
    }

    public function getCodigoBanco(): string
    {
        return $this->get('cod_banco');
    }

    public function getBancoAgencia(): string
    {
        return $this->get('banco_agencia');
    }

    public function getContaBanco(): string
    {
        return $this->get('conta_banco');
    }
}
