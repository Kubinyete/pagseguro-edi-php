...
namespace Kubinyete\Edi\PagSeguro\Http\Client;
...
use Kubinyete\Edi\PagSeguro\Exception\HttpClientException;
use Kubinyete\Edi\PagSeguro\Exception\HttpServerException;
use Kubinyete\Edi\PagSeguro\Exception\HttpTransferException;
